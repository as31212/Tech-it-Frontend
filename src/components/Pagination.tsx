...
import { incrementPage,decrementPage,resetPage,setPage } from "../redux/slices/productFilters";
...
const Pagination: React.FC = () => {
   ...
   //todo figure out a way to reset the page to one whenever the other filters change other than page
